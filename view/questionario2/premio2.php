...
<body>
    <div class="containerPremiacao">
        <div class="containerImgPremiacao">
            <img src="../../assets/img/robo.png" alt="">

            <div id="emitter"></div>
        </div>
        <div class="containerDescricaoPremiacao">
            <span class="spnDescPremio">Você avançou para a terceira fase!</span>
            <span class="spnPremio">parabéns!</span>
        </div>  

        <div class="voltage-button">
            
            <button>Próximo Desafio</button>
...
<script>
    document.querySelector(".voltage-button button").addEventListener("click", function(event) {
        event.preventDefault(); // Previne comportamentos inesperados do botão
        window.location.href = "../questionario3/questionario3.php"; // Redireciona para a nova página
    });
</script>
